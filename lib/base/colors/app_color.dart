...
class AppColor {
  ...
  /// Color of the text on primary button set white.
  ...
  /// Color of the text on secondary button set black.
  static const Color secondaryButtonTextColor = Colors.black;

  /// Color of border of text field
  static const Color textFieldBorderColor = Color(0xffefefef);
